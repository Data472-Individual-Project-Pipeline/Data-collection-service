...
class Tya51Processor:
    ...
    def insert_data(self, table_name, data_list, owner):
        ...
        for data in data_list:
            ...
            if table_name == 'tya51_observation':
    ...
    def create_tables(self, location_table_schema, observation_table_schema):
        self.check_and_create_table('tya51_location', location_table_schema)
        self.check_and_create_table('tya51_observation', observation_table_schema)
    ...
    def process(self, location_url, observation_base_url, owner):
        ...
        self.insert_data('tya51_location', location_data, owner)
        
        # Fetch and insert observation data
        observation_data = self.try_fetch_data_for_days(observation_base_url)
        if observation_data:
            self.insert_data('tya51_observation', observation_data, owner)
        else:
